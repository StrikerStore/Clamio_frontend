...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-gray-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="mx-auto w-28 h-28 bg-gradient-to-br from-white/40 to-blue-50/30 backdrop-blur-xl rounded-3xl flex items-center justify-center mb-6 shadow-xl border border-white/30 transform hover:scale-105 transition-all duration-300 p-4">
            <img src="/logo.png" alt="Claimio Logo" className="w-full h-full object-contain drop-shadow-md" />
          </div>
          <h1 className="text-4xl font-bold text-slate-700 mb-2 drop-shadow-sm">Claimio</h1>
          <p className="text-slate-600 text-lg font-medium">Tap. Claim. Complete.</p>
        </div>
