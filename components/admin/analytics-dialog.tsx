...
export function AnalyticsDialog({
    ...
    const fetchAnalytics = async () => {
        ...
        try {
            ...
            let response;
            // If admin and no specific vendor selected, use overview
    ...
    // Specific Status Ordering and Colors as requested
                        ...
                        <div className={`grid grid-cols-2 lg:grid-cols-4 gap-4`}>
                            <Card className="border-l-4 border-l-indigo-500 shadow-sm transition-all hover:shadow-md">
                                <CardContent className="p-4 flex items-center gap-3">
                                    ...
                                    <div className="min-w-0">
                                        <p className="text-sm text-slate-500 font-medium uppercase tracking-tight">Total Claimed</p>
                                        <p className="text-2xl font-bold text-slate-900">{data.stats.total_claimed}</p>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-l-4 border-l-green-500 shadow-sm transition-all hover:shadow-md">
                                <CardContent className="p-4 flex items-center gap-3">
                                    ...
                                    <div className="min-w-0">
                                        <p className="text-sm text-slate-500 font-medium uppercase tracking-tight">Handed Over</p>
                                        <p className="text-2xl font-bold text-slate-900">{data.stats.total_handed_over}</p>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-l-4 border-l-amber-500 shadow-sm transition-all hover:shadow-md">
                                <CardContent className="p-4 flex items-center gap-3">
                                    ...
                                    <div className="min-w-0">
                                        <p className="text-sm text-slate-500 font-medium uppercase tracking-tight">Fulfill Rate</p>
                                        <p className="text-2xl font-bold text-slate-900">{data.stats.fulfillment_rate}%</p>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-l-4 border-l-purple-500 shadow-sm transition-all hover:shadow-md">
                                <CardContent className="p-4 flex items-center gap-3">
                                    ...
                                    <div className="min-w-0">
                                        <p className="text-sm text-slate-500 font-medium uppercase tracking-tight">Avg Handover</p>
                                        <p className="text-2xl font-bold text-slate-900">
                                            {data.stats.avg_handover_hours > 0 ? `${data.stats.avg_handover_hours}h` : "N/A"}
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <Card className="shadow-sm border-slate-200">
                                <CardHeader>
                                    ...
                                    <CardDescription>View status percentages and counts</CardDescription>
                                </CardHeader>
                                                            ...
                                                            return (
                                                                <div className="bg-white border shadow-lg rounded-lg p-3 text-sm">
                                                                    ...
                                                                    <div className="flex items-center gap-4">
                                                                        <span className="text-slate-500">Count: <b className="text-slate-900">{entry.count}</b></span>
                                                                        <span className="text-slate-500">Share: <b className="text-blue-600">{entry.percentage}</b></span>
                                                                    </div>
                                                                </div>
                                                            );
                                                        }
                            ...
                            <Card className="shadow-sm border-slate-200">
                                <CardHeader>
                                    ...
                                    <CardDescription>Daily Claimed vs Handover comparison</CardDescription>
                                </CardHeader>
                                <CardContent className="h-[350px]">
                                    {data.trend.length > 0 ? (
                                                                        ...
                                                                        {payload.map((p: any) => (
                                                                            <div key={p.dataKey} className="flex items-center justify-between gap-4">
                                                                                <div className="flex items-center gap-2">
                                                                                    ...
                                                                                    <span className="text-slate-600">{p.name === 'count' ? 'Handover' : 'Claimed'}:</span>
                                                                                </div>
